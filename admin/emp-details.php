...
<td colspan="3"><?php echo $result->mobile;?></td>
    ...
    <a href="emp-salary-history.php?empid=<?php echo htmlentities($result->EmpID);?>&&empname=<?php echo htmlentities($result->fname);?>"  class="btn btn-warning" target="_blank">Benefits History</a>
